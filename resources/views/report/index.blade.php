        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="dari" id="dari" class="form-control" data-dari="{{ request()->input('dari') }}">
                </div>
                <div class="form-group">
                    <label for="sampai">Sampai</label>
                    <input type="date" name="sampai" id="sampai" class="form-control" data-sampai="{{ request()->input('sampai') }}">
                </div>
...
@push('js')
    ...
    $(function(){
        ...
        const dari = $('#dari').data('dari');
        const sampai = $('#sampai').data('sampai');
