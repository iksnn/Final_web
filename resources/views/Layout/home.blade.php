...
<head>
  ...
  <link rel="apple-touch-icon" href="/front/img/logo.jpeg">
  <link rel="apple-touch-icon" sizes="72x72" href="/front/img/logo.jpeg">
  <link rel="apple-touch-icon" sizes="114x114" href="/front/img/logo.jpeg">
...
<body class="relative">
                ...
                <div class="logo-container">
                  <div class="logo-wrap">
                    <a href="/">
                      ...
                      @endphp
                      <img class="logo-dark" src="/uploads/{{$about->logo}}" alt="logo">
                    </a>
                  </div>
                </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-3 megamenu-item">
                                <ul class="menu-list">
                                  ...
                                  <li><a href="/products/{{$subcategory->id}}">{{$subcategory->nama_subkategori}}</a></li>
                                  @endforeach
                                </ul>
                              </div>
                              @endforeach
            ...
            <div class="row">
              ...
              <div class="col-md-3 col-sm-12 col-xs-12">
                <div class="widget footer-about-us">
                  ...
                  <p class="mb-30">Nikmati kelezatan Fresh Nugget , hidangan siap saji yang akan memanjakan lidah Anda. 
                    Fresh Nugget adalah pilihan sempurna untuk camilan, sarapan, atau makanan ringan kapan saja.</p>
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-sm-6 copyright sm-text-center">
                <span>
                  &copy; 2023 Fresh Nugget, Made by <a href="/front/http://deothemes.com">Universitas Budi Luhur</a>
                </span>
              </div>
  ...
  <script>
    // Fungsi untuk menampilkan tombol WhatsApp melayang
    function showWhatsAppButton() {
      var button = document.getElementById("whatsapp-floating-button");
      if (button) {
        button.style.display = "block";
      }
    }

    // Panggil fungsi showWhatsAppButton saat halaman dimuat
