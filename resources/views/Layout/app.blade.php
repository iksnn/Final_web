...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#"/admin_asset/ data-toggle="collapse" data-target="#collapseTwo"
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#"/admin_asset/ data-toggle="collapse" data-target="#pesanan"
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; UMKM 2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <a class="scroll-to-top rounded" href="#/admin_asset/page-top">
