                ...
                <div class="col-md-8" id="customer_details">
                  <div>
                    ...
                    <p class="form-row form-row-last validate-required ecommerce-invalid ecommerce-invalid-required-field" id="billing_last_name_field">
                      <label for="billing_last_name">Kota
                        <abbr class="required" title="required">*</abbr>
                      </label>
                    ...
                    <p class="form-row form-row-last validate-required ecommerce-invalid ecommerce-invalid-required-field" id="billing_last_name_field">
                      <label for="billing_last_name">Provinsi
                        <abbr class="required" title="required">*</abbr>
                      </label>
                      <input type="text" class="input-text" placeholder value name="provinsi" id="billing_last_name">
                    </p>

                    <p class="form-row form-row-last validate-required ecommerce-invalid ecommerce-invalid-required-field" id="billing_last_name_field">
                      <label for="billing_last_name">Kota/Kabupaten
                        <abbr class="required" title="required">*</abbr>
                      </label>
                      <input type="text" class="input-text" placeholder value name="kabupaten" id="billing_last_name">
                    </p>

                    <p class="form-row form-row-last validate-required ecommerce-invalid ecommerce-invalid-required-field" id="billing_last_name_field">
                      <label for="billing_last_name">kecamatan
                        <abbr class="required" title="required">*</abbr>
                      </label>
                      <input type="text" class="input-text" placeholder value name="kecamatan" id="billing_last_name">
                    </p>

                    <p class="form-row form-row-last validate-required ecommerce-invalid ecommerce-invalid-required-field" id="billing_last_name_field">
                      <label for="billing_last_name">Detail Alamat
                        <abbr class="required" title="required">*</abbr>
                      </label>
                      <input type="text" class="input-text" placeholder value name="detail_alamat" id="billing_last_name">
                    </p>

                    <p class="form-row form-row-last validate-required ecommerce-invalid ecommerce-invalid-required-field" id="billing_last_name_field">
                      <label for="billing_last_name">Atas Nama
                        <abbr class="required" title="required">*</abbr>
                      </label>
                      <input type="text" class="input-text" placeholder value name="atas_nama" id="billing_last_name">
                    </p>

                    <p class="form-row form-row-last validate-required ecommerce-invalid ecommerce-invalid-required-field" id="billing_last_name_field">
                      <label for="billing_last_name">No Rekening
                        <abbr class="required" title="required">*</abbr>
                      </label>
                      <input type="text" class="input-text" placeholder value name="no_rekening" id="billing_last_name">
                    </p>

                    <p class="form-row form-row-last validate-required ecommerce-invalid ecommerce-invalid-required-field" id="billing_last_name_field">
                      <label for="billing_last_name">Nominal
                        <abbr class="required" title="required">*</abbr>
                      </label>
                      <input type="text" class="input-text" placeholder value="{{$orders->grand_total}}" name="jumlah" id="billing_last_name" readonly>
                        ...
                        <li class="payment_method_bacs">
                          ...
                          <div class="payment_box payment_method_bacs">
                            <p>Make your payment directly into our bank account. 
                              Please use your Order ID as the payment reference. Your order wont be shipped until the funds have cleared in our account.</p>
                            <p>Nama : {{$about->atas_nama}}</p>
...
@push('js')
  <script>  
    ...
    $('form[name="checkout"]').submit(function (e) {
      e.preventDefault(); // Menghentikan pengiriman formulir agar dapat memvalidasi terlebih dahulu
      
      // Validasi input
      var provinsi = $('input[name="provinsi"]').val();
      var kabupaten = $('input[name="kabupaten"]').val();
      var kecamatan = $('input[name="kecamatan"]').val();
      var detail_alamat = $('input[name="detail_alamat"]').val();
      var atas_nama = $('input[name="atas_nama"]').val();
      var no_rekening = $('input[name="no_rekening"]').val();
      var jumlah = $('input[name="jumlah"]').val();

      if (provinsi === '' || kabupaten === '' || kecamatan === '' || detail_alamat === '' || atas_nama === '' || no_rekening === '' || jumlah === '') {
        alert('Harap isi semua field yang diperlukan.');
      } else {
        // Jika semua input telah diisi, kirim formulir
        this.submit();
      }
    });
